...
exports.default = {
    addItems: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var item, error_1;
    ...
    getItems: function (_, res) {
        try {
            config_1.default.query("SELECT * from items", function (err, response) {
                if (err)
                    throw new Error(err);
